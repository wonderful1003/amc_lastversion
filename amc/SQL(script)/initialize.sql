...
INSERT
INTO screencontent VALUES(seq_screencontent_no.nextval, 10000, SYSDATE,to_date('2017/10/20','YYYY/MM/DD'),to_date('2017/10/20 12:00','YYYY/MM/DD HH24:MI'), to_date('2017/10/20 15:00','YYYY/MM/DD HH24:MI'),'1', 20000,'1','범죄도시', to_date('2017/10/18 18:00','YYYY/MM/DD HH24:MI'),'마동석, 윤계상');
