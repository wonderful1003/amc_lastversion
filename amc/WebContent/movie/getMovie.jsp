   ...
   <div class="container">
         ...
         <div class="row ">
            ...
            <div class="col-md-10">
               ...
               <div class="row center-block col-md-12" >
                  &emsp;&emsp;
                  <button class="btn btn-link btn-lg" name="wish" ><i class='glyphicon glyphicon-heart'></i></button>
                  ...
                  <c:if test="${screenContent.screenContentNo != 0 }">
                     <button  class="btn btn-vimeo"   onClick="javascript:addOpenAlarm()"  name = "ticketOpen">티켓오픈알림</button><!-- -->
                  </c:if>                  
               </div>
      ...
      <div class='row'>
         ...
         <div id="hidden">
            ...
            <input type="hidden" name='screenContent.screenContentNo' value="${screenContent.screenContentNo }">
