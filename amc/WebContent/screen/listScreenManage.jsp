    ...
    <%@ page contentType="text/html; charset=EUC-KR" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <head>
                ...
                <!--  -->
                <script rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/holder/2.9.4/holder.js"></script>
                <script rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/holder/2.9.4/holder.min.js"></script>
